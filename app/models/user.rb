class User < ActiveRecord::Base
  ...
  def user_created_and_following_boxes
    Tag.where('user_id = ? OR user_id IN (?)', self.id, following_users.collect{|user| user.id}).collect do |tag|
